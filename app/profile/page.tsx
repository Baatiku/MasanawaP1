...
export default async function ProfilePage() {
  ...
  return <AppShell active="Profile" title="Profile" subtitle="Manage your Perfect Naira account and security." userName={fullName} accountLabel={`${titleCase(kyc)} account`}>
