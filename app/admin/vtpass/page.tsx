...
export default async function VtpassCatalogPage({ searchParams }: { searchParams?: Promise<{ service_id?: string; service_type?: string; network?: string; error?: string }> }) {
  ...
  return <main className="min-h-screen px-5 py-6 md:px-8 lg:py-10"><div className="mx-auto max-w-5xl">
    ...
    <div className="mt-7"><div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-400/10 text-emerald-400"><ServerCog size={22}/></div><h1 className="mt-5 text-2xl font-bold md:text-3xl">VTpass catalog inspector</h1><p className="muted mt-2 text-sm">Read provider variation IDs and import them inactive for review.</p></div>
