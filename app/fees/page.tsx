...
export const metadata = { title: "Masanawa Fees", description: "How Masanawa presents transaction and provider fees." };

const rows = [
  ["Masanawa-to-Masanawa transfer", "Shown before confirmation", "Any applicable platform fee is disclosed before authorization."],
